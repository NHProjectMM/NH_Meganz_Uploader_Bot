...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 123456)) # Get this value from https://my.telegram.org/apps
    ...
    REDIS_PASS = os.environ.get("REDIS_PASS", "") # Get This Value from http://redislabs.com/try-free (If you don't know how to obtain the a video tutorial is available here:- https://t.me/botzupdate/5)
